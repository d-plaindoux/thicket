...
module.exports = function (value, filename) {
    ...
    function Location(filename,offset,line,character) {
    ...
    Location.prototype.clone = function() {
        return new Location(this.filename, this.offset, this.line, this.character);
    };
    
    Location.prototype.toString = function () {
        if (this.filename) {
            return "line " + this.line + " character " + this.character + " in " + this.filename;
        } 
    ...
    function Stream(value, filename) {
        this.offset = 0;            
        this.value = value;
        this.line = 1;
        this.character = 1;
        ...
        this.lastlocation = new Location(filename, this.offset, this.line, this.character);
    }
    ...
    return new Stream(value, filename);
};
