...
module.exports = (function () {
    ...
    Types.prototype.newVar = function() {
        ...
        return ast.type.variable("'" + newName(this.varnum++));
    };
    ...
    Types.prototype.unify = function(aType1, aType2) {    
        ...
        switch(aType2.$type) {
            case 'TypePolymorphic':
                return that.unify(aType1, this.instantiate(aType2));
        }
    ...
    Types.prototype.instantiate = function (aType) {
        ...
        // console.log("instantiate(" + stringify(aType) + ") = " + stringify(instance) + " [" + instance.$type + "]");
