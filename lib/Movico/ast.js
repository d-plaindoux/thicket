...
exports.ast = (function () {
    ...
    return {
        ...
        type: {
            ...
            array : function (type) { return new TypeSpecialize(new TypeNative("Array"),type); },
            pair : function (left,right) { return new TypeSpecialize(new TypeSpecialize(new TypeNative("Pair"),left), right); }
        },
        expr : {
