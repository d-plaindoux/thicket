        ...
        imports.forEach(function(anImport) {
            ...
            try {
                if (!modules.contains(name)) {
                    ...
                    // TODO -- Must be removed ASAP / This environment must be built elsewhere
                    newEnvironment = newEnvironment.
                        concat(specifications.entities). 
                        concat(analyzeImports(modules, reader, specifications.imports));
                }
            } catch (e) {                
