    ...
    function normalizeExpression(bindings, expressionToNormalize) {
        ...
        switch (expression.$type) {
            ...
            case 'ComprehensionExpr': // OK
                ...
                return normalizeExpression(bindings, newExpression);
            case 'TagExpr': 
                newExpression = ast.expr.application(ast.namespace(ast.expr.ident("document"),"Client.Document"),
                                                     ast.namespace(ast.expr.string(expression.name),"Data.String"));
                ...
                expression.attributes.map(function(attribute) {
                    ...
                    newExpression = ast.expr.application(newExpression, ast.namespace(ast.expr.string(attribute[0]),"Data.String"));
