            ...
            case 'TypeSpecialize*EntitySpecialization':
                if (aType1.type.$t === 'TypeVariable') {
                    ...
                    zipWith(list(aType2.parameters)).foldL(aTry.success(list()), function (result, pair) {
                        ...
                        return that.unify(aType1.type, that.generalizeEntity(aType2.type), environment).
            ...
            case 'EntitySpecialization*TypeSpecialize':
                if (aType2.type.$t === 'TypeVariable') {
                    ...
                    zipWith(list(aType2.parameters)).foldL(aTry.success(list()), function (result, pair) {
                        ...
                        return that.unify(that.generalizeEntity(aType1.type), aType2.type, environment).
                        map(function (substitutions) {
                            return result.append(substitutions);
                        });
                    });
