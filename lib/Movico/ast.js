...
exports.ast = (function () {
    ...
    Model.prototype.clone = function () {
        return new Model(this.name, this.generics, this.params);
    };
    ...
    function Controller(name, generics, param, specifications, behaviors) {
        this.name = name;
        this.generics = generics;        
        this.param = param;
    ...
    Controller.prototype.clone = function () {
        return new Controller(this.name, this.generics, this.param, this.specifications, this.behaviors);
    };
    ...
    function View(name, generics, param, body) {
        this.name = name;
        this.generics = generics;
        this.param = param;
        this.body = body;
    ...
    View.prototype.clone = function () {
        return new View(this.name, this.generics, this.param, this.body);
    };
    ...
    return {
        model : function (name, generics, params, parent) { return new Model(name, generics, params, parent); },
        controller : function (name, generics, param, specifications, behaviors) { return new Controller(name, generics, param, specifications, behaviors); },
        view : function (name, generics, param, body) { return new View(name, generics, param, body); },
        ...
        type: {
            forall: function (variables, type) { return new TypePolymorphic(variables, type); },
