    ...
    Runtime.prototype.register = function(current, namespace) {
        ...
        switch(getInstruction(current)) {
            ...
            case "CLASS":
                ...
                break;
            case "DEFINITION":
                current.DEFINITION[1] = current.DEFINITION[1].concat({RETURN:1});
        ...
        while (code.length !== 0) {            
            ...
            switch(instruction) {
                ...
                case "DEFINITION":
                    ...
                    code = current.DEFINITION[1].slice();
                    env = [];
                ...
                case "INVOKE":
                case "TAILINVOKE":
                    v = current[instruction]; // Method | Attribute name
                    c = stack.shift();  
                ...
                case "R_NATIVE":
                    ...
                    break;    
                case "R_ANYINVOKE":
                    v = current.R_ANYINVOKE; // Method | Attribute name
                    c = stack.shift();                        
