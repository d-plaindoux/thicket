...
module.exports = (function () {
    ...
    function compiletApplication(namespace, environment, variables, expression, lazy) {
    ...
    function compileExpression(namespace, environment, variables, expression) {
        ...
        switch (expression.$type) {
            ...
            case 'ApplicationExpr':
                result = compiletApplication(namespace, environment, variables, expression, true);
            ...
            case 'LetExpr': // OK
                ...
                result = compiletApplication(namespace, environment, variables, newExpression, false); 
                break;
