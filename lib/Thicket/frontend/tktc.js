...
var analyzer = require('../compiler/analyzer.js'),
    ...
    entity = require('../compiler/checker/entity.js'),
...
function main() {
    var argv = parseArgv.
        ...
        driver = option.some(argv.i || argv.o).map(function(directory) {
            return require('../Thicket/resource/drivers/fsdriver.js')(directory);
        }),
        reader = driver.map(function(driver) {
            return require('../Thicket/resource/reader.js')(driver);    
        }),        
        writer = option.some(argv.o).map(function(directory) {
            return require('../Thicket/resource/writer.js')(directory);
        }),
        packages = require('../Thicket/compiler/Data/packages')(option.none()),
        debug = argv.d,        
        loadedModules;
    ...
    loadedModules.forEach(function(loadedModule) {   
        ...
        currentModule.imports.forEach(function(anImport) {
            packages.retrieve(anImport.namespace).map(function (importedModule) {
