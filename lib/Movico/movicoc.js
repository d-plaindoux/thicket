...
module.exports = (function () {
    ...
    function analyzeModule(data) {
        return analyze('module', data).map(function (sourcesOrNothing) {
            return sourcesOrNothing.map(function (aModule) {
                imported[aModule.namespace.join('.')] = true;
    ...
    function analyzeImports(readSpecifications, readDependencies, imports) {
        var newEnvironment = [];
        
        imports.forEach(function(anImport) {
            var name = anImport.namespace.join(".");
            option.some(imported[name]).orLazyElse(function () {
        ...
        imports.forEach(function(anImport) {
            var name = anImport.namespace.join(".");
            option.some(imported[name]).orLazyElse(function () {
                imported[anImport.namespace.join(".")] = true;
