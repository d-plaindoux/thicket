...
exports.language = function () {
    ...
    Language.prototype.controller = function () {
        ...
        this.parser.group('method').
            addRule(["def", bind(this.E('ident')).to('name'), "=", commit(bind(this.E("exprs")).to('body'))], function (scope) {
            ...
            addRule(["def", bind(this.E('ident')).to('name'), bind(optrep(TIDENT)).to("generics"), bind(rep(this.E("param"))).to('params'), "=", bind(this.E("exprs")).to('body')], function (scope) {
    ...
    Language.prototype.expression = function () {
        ...
        this.parser.group("fun-body").
            ...
            addRule([bind(optrep(TIDENT)).to("generics"), bind(rep(this.E("param"))).to('params'), "=>", bind(this.E('exprs')).to('body')], function (scope) {
                var result = scope.body;
                scope.params.reverse().forEach(function (param) {
                    result = ast.expr.abstraction(param, result);
                });
        ...
        this.parser.group('let-body').
            ...
            addRule([bind(optrep(TIDENT)).to("generics"), bind(rep(this.E("param"))).to('params'), '=', bind(this.E('exprs')).to('expr'), "in", bind(this.E('exprs')).to('body')], function (scope) {
                var result = scope.expr;
                scope.params.reverse().forEach(function (param) {
                    result = ast.expr.abstraction(param, result);
                });
