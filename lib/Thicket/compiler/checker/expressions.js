...
module.exports = (function () {
    ...
    function getNamespaceExpression(environment, name) {
        return environment.findNamespace(name).recoverWith(null);
    }
    ...
    function analysePairExpression(bindings, environment, substitutions, expression, type) {
        ...
        var ident = ast.namespace(ast.expr.ident("Pair"), getNamespaceExpression(environment, "Pair")),
