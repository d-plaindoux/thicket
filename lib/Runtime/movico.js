...
exports.M = (function() {
    ...
    function Movico() {
        ...
        this.define('string', function(native) { return { '[id]':'string',_:native };});
        this.define('number', function(native) { return { '[id]':'number',_:native };});
        this.define('xml', function(native) { return { '[id]':'string',_:native };});
    }
    ...
    Movico.prototype.lookup = function(o,n) {
        ...
        if (o.hasOwnProperty(callerName + "." + n)) {
        ...
        throw new Error("method not found " + callerName + "." + n);
    };
