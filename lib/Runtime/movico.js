...
module.exports.M =  (function() {
    ...
    function getType(o) {
        if (typeof(o) === 'object') {
            return o.constructor.toString(o).match(/^(function|object)\s(.*)\(/)[2];
        } else {
            return typeof(o);
        }
    }
    ...
    function Movico() {
        ...
        that.deltarules = {};
        that.environment = {};
        that.code("string.toXml", function(n1){
            var v1 = that.$$(n1)['[this]'];                
        ...
        switch (getType(code)) {
            ...
            case 'Tag':
                ...
                code.attributes.forEach(function (attribute) {
                    element.appendChild(document.createAttribute(attribute[0],that.$$(attribute[1])));
                });
                code.body.forEach(function (body) {
                    element.appendChild(that.$$(that.$$(body)));
                });
                return element;
            case 'Ident':
