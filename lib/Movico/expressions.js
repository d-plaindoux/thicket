...
exports.expressions = (function () {
    ...
    function analyseInstanceExpression(nongenerics, variables, expression) {
            ...
            switch (reflect.typeof(entity)) {
                ...
                case 'Controller':                            
                    return list(entity.behaviors).findFirst(function (behavior) {
                        ...
                        if (behavior.type === undefined) {
                             behavior.type = types.newVar();
                        }
    ...
    function analysePolymorphicExpression(nongenerics, variables, expression) {
    ...
    function analyseExpression(nongenerics, variables, expression) {
        switch (reflect.typeof(expression)) {
            ...
            case 'InstanceExpr':
                return analyseInstanceExpression(nongenerics, variables, expression);
            case 'InvokeExpr':
            ...
            case 'PolymorphicExpr':
                return analysePolymorphicExpression(nongenerics, variables, expression);
            default:
