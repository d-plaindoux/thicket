...
exports.entities = (function () {
    ...
    var predefined = [
        ...
        pair("Pair", ast.type.forall(["a", "b"],ast.model("Pair",
                                                          [ast.type.variable("a"),
                                                           ast.type.variable("b")],
    ...
    function analyseEntity(nongenerics, environment, substitutions, patternSubstitutions, entity) {
        ...
        switch (reflect.typeof(entity)) {
            ...
            case 'Controller':
                environment = list(pair("self", types.substitute(substitutions, entity))).append(environment);
                ...
                return list(entity.behaviors).foldL(aTry.success(entity), function (result, method) {
                    ...
                    return result.flatmap(function() {
                        return list(entity.specifications).findFirst(function (specification) {
                            ...
                            newEnvironment = list(pair(entity.param.name, types.substitute(substitutions.append(patternSubstitutions), callerType))).append(environment);

                            return expressions.analyse(nongenerics, newEnvironment, newSubstitutions, method.definition, genericsAndTypes._2).flatmap(function() {
                                return result;
                            });                        
                        });
                    });
            ...
            case 'View':
                ...
                return list(entity.body).foldL(aTry.success(entity), function (result, body) {
                    ...
                    return result.flatmap(function () {
                        return expressions.analyse(nongenerics, environment, substitutions, body, expressions.native(substitutions, "xml")).flatmap(function () {
                            return result;
                        });
                    });
                });
