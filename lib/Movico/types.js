    ...
    function unify(aType1, aType2) {
        ...
        switch (type.get(aType1) + "|" + type.get(aType2)) { 
            ...
            case 'TypeFunction|TypeFunction':
                return unify(aType1.argument, aType2.argument).flatmap(function (bindings1) {
                    return unify(aType1.result, aType2.result).map(function (bindings2) {
                        return bindings2.map(function (binding) {
                            return pair(binding._1, substitute(bindings1, binding._2));
                        }).concat(bindings1);
                    });
                });
            case 'TypePair|TypePair':
                return unify(aType1.first, aType2.first).flatmap(function (bindings1) {
                    return unify(aType1.second, aType2.second).map(function (bindings2) {
                        return bindings2.map(function (binding) {
                            return pair(binding._1, substitute(bindings1, binding._2));
                        }).concat(bindings1);
                    });
