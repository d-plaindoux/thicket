...
module.exports = (function() {
    ...
    // [DISCLAIMER] 
    // Lazy evaluation is not yet efficient!
    // It' done using sub abstract machine for the moment
        ...
        while (code.length > 0) {
            ...
            switch(getInstruction(current)) {
                ...
                case "ALTER":
                    n = current.ALTER;
                    v = stack.shift();
                    m = this.executeIfLazy(stack.shift());                    
                ...
                case "RETURN":
                    ...
                    code = c.slice();
                    env = e.slice();
                    stack.unshift(this.executeIfLazy(v));
                    break;
                case "LAZY":
