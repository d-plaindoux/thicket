...
exports.entities = (function () {
    ...
    function analyseEntity(nongenerics, environment, substitutions, entity) {
        ...
        switch (reflect.typeof(entity)) {
            case 'TypePolymorphic':
                ...
                return analyseEntity(nongenerics.append(list(entity.variables)), environment, newSubstitutions, entity.type);
                ...
                return list(entity.behaviors).foldL(aTry.success(entity), function (result, method) {
                    ...
                    return result.flatmap(function() {
                        return list(entity.specifications).findFirst(function (specification) {
                            ...
                            return types.unify(types.substitute(substitutions, callerType), types.substitute(substitutions, entity.param.type)).map(function () {
                            ...
                            newEnvironment = list(pair(entity.param.name, types.substitute(substitutions, callerType))).append(newEnvironment);
                            ...
                            return expressions.analyse(nongenerics, newEnvironment, newSubstitutions, method.definition).flatmap(function(substitutionsAndType) {
                                return unify(types.substitute(newSubstitutions, genericsAndTypes._2), substitutionsAndType._2).flatmap(function() {
                                    return result;
                                });
                            });                        
                        });
    ...
    Entities.prototype.analyse = function (environment, substitutions, entity) {
        return analyseEntity(list(), environment, substitutions, entity);
    };
    ...
    Entities.prototype.substitutions = function (entities) {
        var typeDef = list(["number","string","xml","unit"]),            
            substitutions = list(entities.orElse([])).foldL(list(), function (result, entity) {       
                return result.append(list(pair(getName(entity), entity)));
            });
