...
exports.language = function () {
    ...
    function Language() {
        ...
        this.parser.group('expr').
            addRule([bind(entry("iexpr")).to('expr'), bind(optrep([",",entry('sexpr')])).to('exprs')], function (scope) {
                var result = null;
        ...
        this.parser.group('sexpr').
            ...
            addRule(bind(entry("native")).to('native'), function (scope) {
                return scope.native;
            }).
