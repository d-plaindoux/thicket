        ...
        if (code.length > 0) {
            ...
            switch(getInstruction(current)) {
                ...
                case "MODEL":                      
                    ...
                    break;                    
                case "CLASS":
                    this.executeWhenLazy(executionStack, env[0], function(result) {
                ...
                case "ALTER":
                    n = current.ALTER;
                    v = stack.shift();
                    this.executeWhenLazy(executionStack, stack.shift(), function(m) {
                ...
                case "INVOKE":
                    ...
                    stack.unshift(env);
                    stack.unshift(code);
                    this.executeWhenLazy(executionStack, c, function(c) {
                ...
                case "RETURN":
                    ...
                    code = c.slice();
                    env = e.slice();
                    this.executeWhenLazy(executionStack, v, function(v) {
                        stack.unshift(v);
                        that.executeNextCode(executionStack,code,env,stack);
                    });
                    return;
