...
function main() {
    ...
    loadedModules = argv._.map(function(value) {
        ...
        if (result.isSuccess()) {
            return result.map(function (moduleDefinitionAndEntities) {
                ...
                modules.define(moduleName, moduleDefinitionAndEntities[1]);                   
    ...
    loadedModules.forEach(function(loadedModule) {
        loadedModule.map(function(moduleDefinitionAndEntities) {
            ...
            reader.map(function(reader) {
                allEntities = allEntities.concat(analyzer.imports(modules, reader, moduleDefinitionAndEntities[1][0]));
    ...
    loadedModules.forEach(function(loadedModule) {            
        ...
        moduleDefinitionAndEntities = analyzer.entities(allEntities, loadedModule.success()[1][1]).flatmap(function () {
            return loadedModule;
        });
