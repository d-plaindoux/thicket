...
module.exports = (function() {
    ...
    Runtime.prototype.execute_PARAMETER = function(runtime, v, i) {
        ...
        if (r) {
            ...
            runtime.envToStack(v[1][1].slice());
    ...
    Runtime.prototype.execute_DEFINITION = function(runtime, current) {
        ...
        runtime.setEnv([]);                    
        runtime.setCode(current[1][1].concat([[ $i.code.RETURN ]]));
    };
    ...
    Runtime.prototype.execute_R_ANYINVOKE = function(runtime, current) {
        ...
        if (isClassInstance(c[1][0])) {
            runtime.setCode(this.lookupMethodOrInternal(c[1][0], c[1][1], v).concat([[ $i.code.RETURN ]]));
            runtime.setEnv([[ $i.code.OBJ, [c[1][0], c[1][1]] ], c[1][1]]);
        } else {
            runtime.setCode(this.lookupAttribute(c[1][0], v).concat([[ $i.code.RETURN ]]));
            runtime.setEnv(c[1][1].slice());
        }
    };
