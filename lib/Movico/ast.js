...
exports.ast = (function () {
    ...
    function Controller(name, param, specifications, behaviors) {
        this.name = name;
        this.param = param;
    ...
    return {
        ...
        controller : function (name, param, specifications, behaviors) { return new Controller(name, param, specifications, behaviors); },
