...
module.exports.movicoc = (function() {
    var stream = require('../Parser/stream.js').stream,
        ...
        language = require('./syntax/language.js').language(),
        types = require('./checker/types.js').types,
        entities = require('./checker/entities.js').entities,
        expressions = require('./checker/expressions.js').expressions,
        compiler = require('./compiler/codegen.js').compiler;
