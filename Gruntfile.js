...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
        ...
        thicket_site: 'find thicket-site -name *.tkt | xargs ./bin/thicketc -i site/ -o site',
        thicket_examples: 'find thicket-examples -name *.tkt | xargs ./bin/thicketc -i site/ -o site'
    },
    uglify: {
        options: {
            mangle: false,            
