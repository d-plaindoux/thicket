...
module.exports = (function() {
    ...
    Toplevel.prototype.manageEntities = function(entitiesAndSentences) {        
        ...
        if (result.isFailure()) {
            this.packages.restore(previousRootPackage);
        }
    ...
    Toplevel.prototype.manageModule = function(module) {        
        ...
        result = linker(that.packages).linkEntities(that.packages.main(), list(module.entities)).flatmap(function() {
    ...
    Toplevel.prototype.manageModuleCode = function(content) {        
        var that = this,
            result = analyzer.module(content).flatmap(function (module) {        
