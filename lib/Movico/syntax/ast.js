...
module.exports = (function () {
    ...
    function TypeRecursive(name, type) {
        this.$type = reflect.typeof(this);        
        this.name = name;
        this.type = type;
    }
    
    TypeRecursive.prototype.toString = function () {
    ...
    AbstractionExpr.prototype.toString = function () {
        return '(' + this.param + (this.type?":"+this.type:"") + ' -> ' + this.body + ')';
    };
    ...
    return {
        ...
        type: {
            recursive : function (name, type) { new TypeRecursive(name, type); },
