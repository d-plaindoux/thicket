...
module.exports = (function () {
    ...
    function analyzeImports(environment, imports) {
    ...
    function compileSentence(environment, data) {
        ...
        return option.some(aTry.success({ 
            type   : types.reduce(types.substitute(type.success()._1, type.success()._2)).recoverWith(types.substitute(type.success()._1, type.success()._2)),  
            expr   : expression.get(), 
        }));
    }
