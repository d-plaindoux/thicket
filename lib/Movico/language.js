...
exports.language = function () {
    ...
    Language.prototype.controller = function () {
        ...
        this.parser.group('method').
            addRule(["def", bind(this.E('methodname')).to('name'), "=", 
                     commit(bind(this.E("exprs")).to('body'))], function (scope) {
                return ast.method(scope.name, scope.body);
            }).
            addRule(["def", bind(this.E('methodname')).to('name'), "(", commit([")", "=", 
            ...
            addRule(["def", bind(this.E('methodname')).to('name'), bind(optrep(TIDENT)).to("generics"), bind(rep(this.E("param"))).to('params'), "=", 
                     bind(this.E("exprs")).to('body')], function (scope) {
    ...
    Language.prototype.view = function () {
        ...
        this.parser.group('viewDef').
            addRule(["view", bind(this.E('ident')).to('name'), bind(optrep(TIDENT)).to("generics"), bind(this.E('param')).to('param'),
    ...
    Language.prototype.expression = function () {
        ...
        this.parser.group("fun-body").
            ...
            addRule([bind(optrep(TIDENT)).to("generics"), bind(rep(this.E("param"))).to('params'), "=>", 
                     bind(this.E('exprs')).to('body')], function (scope) {
                var result = scope.body;
                scope.params.reverse().forEach(function (param) {
                    result = ast.expr.abstraction(param, result);
