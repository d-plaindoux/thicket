...
module.exports = (function () {
    ...
    Linker.prototype.linkType = function(namespace, aType, variables) {
        ...
        switch (aType.$type) {
            ...
            case 'TypeVariable':
                ...
                return self.findNamespace(namespace, aType.name).map(function (namespace) {
            ...
            case 'Expression':
            case 'Typedef':
                return self.linkEntity(namespace, aType, variables);
    ...
    Linker.prototype.linkExpression = function(namespace, expression, variables, typeVariablesOrNull) {
        var self = this,
            typeVariables = typeVariablesOrNull ? typeVariablesOrNull : list();
        ...
        switch (expression.$type) {
            ...
            case 'IdentExpr':
                ...
                return self.findNamespace(namespace, expression.value).map(function (namespace) {
            ...
            case 'Controller':                
                return list(entity.specifications).foldL(aTry.success(null), function (result, specification) {
                    ...
                    return list(entity.behaviors).foldL(r, function (result, behavior) {
                        return result.flatmap(function() {
                            return self.linkExpression(namespace, behavior.caller, list("self", entity.param.name), variables);
                        });                        
                    });
                });
