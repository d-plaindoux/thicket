...
module.exports = (function () {
    ...
    function normalizeApplication(namespace, environment, variables, expression) {
        var newExpression;
    ...
    function normalizeExpression(namespace, environment, variables, expression) {
        ...
        switch (expression.$type) {
                ...
                return list(expression.attributes).foldL(aTry.success(list()),function (result, attribute) {
                    return result.flatmap(function (result) {
                        return normalizeExpression(namespace, environment, variables, attribute[1]).map(function (value) {
                            var attributeName = normalizeExpression(namespace, environment, variables, ast.expr.string(attribute[0]));
                    ...
                    return list(expression.body).foldL(aTry.success(list()),function (result,body) {
                        ...
                        var tagName = normalizeExpression(namespace, environment, variables, ast.expr.string(expression.name));
            ...
            case 'NewModelExpr': //
                var model = normalizeExpression(namespace, environment, variables, expression.model);
                
                return list(expression.alter).foldL(model,function(result,alter) {
                    return model.flatmap(function(model) {
                        return normalizeExpression(namespace, environment, variables, alter[1]).map(function(alteredExpression) {
