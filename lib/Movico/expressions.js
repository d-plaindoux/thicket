...
exports.expressions = (function () {
    ...
    function analyseExpression(nongenerics, variables, expression) {
        switch (reflect.typeof(expression)) {
            ...
            case 'TagExpr': 
                return list(expression.attributes).foldR(function (attribute, result) {
                    return result.flatmap(function () {
                        return analyseExpression(nongenerics, variables, attribute[1]).flatmap(function (variablesAndAttribute) {
                            return types.unify(variablesAndAttribute._2, ast.type.native("string")).flatmap(function () {
                                return result;
                            });
                        });
                    });
                }, aTry.success(ast.type.native("XML"))).flatmap(function (result) {
                    return list(expression.body).foldR(function (body, result) {
                        return result.flatmap(function () {
                            return analyseExpression(nongenerics, variables, body).flatmap(function (variablesAndAttribute) {
                                if (types.unify(variablesAndAttribute._2, ast.type.native("string")).isSuccess()) {
                                    return result;
                                }
                            
                                return types.unify(variablesAndAttribute._2, ast.type.native("XML")).flatmap(function () {
                                    return result;
                                });                            
                            });                            
                        });
                    }, aTry.success(result)).map(function (result) {
