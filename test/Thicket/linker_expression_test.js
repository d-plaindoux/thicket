...
exports['linker_expression'] = {
  ...
  'Link Number': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list(), list()).isSuccess());
  ...
  'Link Variable Ident': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list("a"), list()).isSuccess());
  ...
  'Cannot Link Invoke': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list(), list()).isFailure());
  ...
  'Link Application': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list("print"), list()).isSuccess());
  ...
  'Link Simple Comprehension': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list("l"), list()).isSuccess());
  ...
  'Cannot Link Simple Comprehension': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list("l"), list()).isFailure());
  ...
  'Link Tag with attributes': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list("b"), list()).isSuccess());
  ...
  'Link Let value': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list("c"), list()).isSuccess());
  ...
  'Link New Model Alteration': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list("a", "b"), list()).isSuccess());
  ...
  'Cannot Link New Model Alteration': function(test) {
    ...
    test.ok(aLinker.linkExpression("_", expression, list("a"), list()).isFailure());
