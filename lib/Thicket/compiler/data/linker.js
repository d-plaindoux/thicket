                ...
                return self.linkType(namespace, aType.type, variables, allowed).flatmap(function(result) {
                    return list(aType.parameters).foldL(aTry.success(result), function(result, parameter) {
                        return result.flatmap(function() {
                            return self.linkType(namespace, parameter, variables, allowed);
                        });
                    });                   
                });
                
            case 'TypeFunction':
                return self.linkType(namespace, aType.argument, variables, allowed).flatmap(function() {
                    return self.linkType(namespace, aType.result, variables, allowed);
                });
            ...
            case 'Trait': 
                return list(entity.specifications).foldL(aTry.success(null), function (result, specification) {
                    ...
                    return list(entity.derivations).foldL(aTry.success(null), function (result, derivation) {
                        return result.flatmap(function() {
                            return self.linkType(namespace, derivation, variables, {});
                        });
                    });
                }).flatmap(function(r) {
                ...
                return list(entity.specifications).foldL(aTry.success(null), function (result, specification) {
                    ...
                    return list(entity.behaviors).foldL(aTry.success(r), function (result, behavior) {
                        return result.flatmap(function() {                            
                            ...
                            if (behavior.caller) {
                                return self.linkType(namespace, behavior.caller, variables, {models:true});
                            }                             
                            return aTry.success(result);
                        });
                    });
                }).flatmap(function() {
                    return self.linkType(namespace, entity.param.type, variables, {});
                });
