...
module.exports = (function () {
    ...
    function Imports(namespace, entitiesName) {
        this.namespace = namespace;
        this.names = entitiesName;
    }
    ...
    function TypeStructure(params) {
        this.$type = "structure";        
        this.params = params;
    }
    
    TypeStructure.prototype.toString = function() {
        return "{" + this.params.map(function(p) { return (p.name + ":" + p.type); }).join(' ') + "}";
    };
    ...
    return {
        ...
        type: {
            structure: function (params) { return new TypeStructure(params); },
